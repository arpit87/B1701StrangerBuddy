...
import my.b1701.SB.Adapter.GridViewImageAdapter;
...
import my.b1701.SB.MapHelpers.NearbyUserOverlayItem.NearbyUserOnTouchListener;
	...
	protected void createAndDisplayIndividualUserExpandedView(final NearbyUser n)
	{
		...
		params.mode = MapView.LayoutParams.MODE_MAP;
			...
			smsIcon.setOnClickListener(new OnClickListener() {				
				@Override
				public void onClick(View buttonClose) {
					CommunicationHelper.getInstance().onSmsClickWithUser(n.getUserOtherInfo().getUserID());
				}
				});
		...
		{		
			...
			picGridView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View v,
					...
					removeExpandedView();
					createAndDisplayIndividualUserExpandedView(mUserGroup.getNearbyUserAt(position));
